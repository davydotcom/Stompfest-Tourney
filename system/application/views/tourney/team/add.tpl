    ...
    <form action="/tourney/team/saveNew" method="post" enctype="multipart/form-data">
        ...
        <table>
            <tr>
                ...
                <td><input type="text" id="teamName" maxlength="50" size="50" /></td>
            </tr>
            <tr>
                <td class="DataLabel">Team Website:</td>
                <td><input type="text" id="teamURL" maxlength="125" size="50" /></td>
            </tr>
            <tr>
                <td class="DataLabel">Team Icon:</td>
                <td><input type="file" id="teamIcon" maxlength="50" size="40" class="MyButton" /></td>
            </tr>
